...
public class Level {
	...
	//precondition: flower is hit by the player
	//postcondition: gas created in a rectagle around the flower for as many blocks as chosen
	private void addGas(int col, int row, Map map, int numSquaresToFill, ArrayList<Gas> placedThisRound) {
		...
		while(numSquaresToFill > 0 && placedThisRound.size() > 0){
			...
			//remove the gas tile just processed from placedThisRound
